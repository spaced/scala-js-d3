...
object D3DatumObs {
  ...
  @inline implicit def fromFunction1To3StringPrimitive[Datum](value: scala.Function1[Datum, String]): js.Function3[Datum, Int, Int, Primitive] =
    fromFunction1To3( value.andThen( _.asInstanceOf[Primitive]) )

  @inline implicit def fromFunction1To3DoublePrimitive[Datum](value: scala.Function1[Datum, Double]): js.Function3[Datum, Int, Int, Primitive] =
    fromFunction1To3( value.andThen( _.asInstanceOf[Primitive]) )

  @inline implicit def fromFunction1To3IntPrimitive[Datum](value: scala.Function1[Datum, Int]): js.Function3[Datum, Int, Int, Primitive] =
    fromFunction1To3( value.andThen( _.asInstanceOf[Primitive]) )

  @inline implicit def fromFunction1To3BooleanPrimitive[Datum](value: scala.Function1[Datum, Boolean]): js.Function3[Datum, Int, Int, Primitive] =
    fromFunction1To3( value.andThen( _.asInstanceOf[Primitive]) )
