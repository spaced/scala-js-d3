...
trait Base extends Selectors {
  ...
  def range(stop: js.Number, step: js.Number = 1): js.Array[js.Number] = ???
  //def range(start: js.Number, stop: js.Number, step: js.Number = 1): js.Array[js.Number] = ???
  def nest(): Nest = ???
...
package Transition {
  ...
  trait Transition extends js.Object {
    ...
    def style(name: js.String): js.String = ???
    def style(name: js.String, value: js.Any, priority: js.String = null): Transition = ???
...
package Scale {
  ...
  trait TimeScale extends Scale {
    ...
    def ticks(count: js.Number): js.Array[js.Any] = ???
    def ticks(range: Time.Range, count: js.Number): js.Array[js.Any] = ???
    def tickFormat(count: js.Number): js.Function1[js.Number, js.String] = ???
    //def copy(): TimeScale = ???
  }
